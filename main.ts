...
sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Player, function (sprite, otherSprite) {
    ...
    music.setVolume(255)
    music.playSoundEffect(music.createSoundEffect(WaveShape.Noise, 3300, 1400, 255, 255, 150, SoundExpressionEffect.Warble, InterpolationCurve.Linear), SoundExpressionPlayMode.InBackground)
    info.changeLifeBy(-1)
    music.setVolume(100)
})
